...
class _AnimatedWidgetColumnState extends State<AnimatedWidgetColumn> with SingleTickerProviderStateMixin {
  ...
  void _onScroll() {
    ...
    if (_scrollController.position.pixels > 0 && _scrollController.position.pixels < _scrollController.position.maxScrollExtent) {
      ...
      child: SizedBox(
        ...
        child: Column(children: [
          FadeTransition(
              ...
              child: Text(
                widget.title,
                style: TextStyle(color: Colors.indigo.shade900, fontSize: 30, fontWeight: FontWeight.bold),
                softWrap: true,
                maxLines: 3,
          ...
          Padding(
            ...
            child: Align(
              ...
              child: FadeTransition(
                  ...
                  child: Hover_Button(defaultcolor: Colors.green, hovercolor: Colors.green, width: ww, text: 'Read More >', ontap: () {}, fontsize: ww * 0.01)),
            ),
          ),
        ]),
      ),
