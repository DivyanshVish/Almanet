...
import '../../../constants/dummy_data/industries_dummy_data.dart';
import '../../provider/crm_provider.dart';

class EditButtonCrmPage extends StatefulWidget {
  const EditButtonCrmPage(
      {super.key,
  ...
  @override
  State<EditButtonCrmPage> createState() => _EditButtonCrmPageState();
}

class _EditButtonCrmPageState extends State<EditButtonCrmPage> {
  @override
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: DropdownButton<String>(
                          ...
                          value:
                              context.watch<CRMProvider>().selectedCompanyGroup,
...
//  final docUser = await FirebaseFirestore.instance.collection('leads').doc('id');
...
//
//           'numberOfTeamMembers': numberOfTeamMembersController,
//         });
