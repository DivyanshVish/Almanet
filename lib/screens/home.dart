                      ...
                      children: [
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                  'SOLUTIONS',
                                  style: TextStyle(fontSize: ww * 0.01, fontWeight: FontWeight.bold, color: Colors.green),
                                ),
                                Padding(
                                  padding: EdgeInsets.only(top: hh * 0.02, bottom: hh * 0.03),
                                  child: Text(
                                    'Less cookie-cutter, more tailored expertise',
                                    style: TextStyle(fontSize: ww * 0.015, fontWeight: FontWeight.bold, color: Colors.indigo.shade900),
                                  ),
                                ),
                                Text(
                        ...
                        FadeInFromLeftToRight(
                          widgets: [
                            ...
                            Home_Services(
                                Title: 'SAP S/4HANA',
                                Description: 'We provide SAP technology and industry expertise, tangible solutions, and a personalized approach to ensure you maximize your software investment.',
                                ontap: () {
                                  Get.to(() => sap_s4hana());
                                }),
                            Home_Services(Title: 'SAP Services', Description: 'We provide SAP technology and industry expertise, tangible solutions, and a personalized approach to ensure you maximize your software investment.', ontap: () {}),
                      ...
                      children: [
                        Padding(
                          ...
                          child: Align(
                            child: Text(
                              'Blog',
                              style: TextStyle(color: Colors.blue, fontSize: ww * 0.015),
                            ),
                    ...
                    child: Center(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text(
                            'Join our team',
                            style: TextStyle(color: Colors.white, fontSize: ww * 0.015, fontWeight: FontWeight.bold),
                          ),
                        ),
                        Text(
                          'We engage and hire the best talent',
                          style: TextStyle(color: Colors.white, fontSize: ww * 0.011, fontWeight: FontWeight.bold),
                        ),
                        Container(
                            width: ww * 0.3,
                            child: Text(
